...
IRONDB_URLS = (
     os.environ.get('IRONDB_URLS', '').split(",")

)

IRONDB_BATCH_SIZE = int(os.environ.get('IRONDB_BATCH_SIZE', '250'))
...
IRONDB_TIMEOUT_MS = int(os.environ.get('IRONDB_TIMEOUT_MS', '10000'))
IRONDB_CONNECTION_TIMEOUT_MS = int(os.environ.get('IRONDB_CONNECTION_TIMEOUT_MS', '3005'))
IRONDB_MAX_RETRIES = int(os.environ.get('IRONDB_MAX_RETRIES', '2'))
